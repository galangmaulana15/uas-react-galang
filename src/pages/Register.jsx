...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // ✅ PERUBAHAN: Setelah daftar berhasil, langsung ke halaman login
        navigate('/login', {
          state: {
            message: 'Account created successfully! Please login.',
            registeredEmail: formData.email, // Opsional: kirim email untuk pre-fill
          },
        })
      }
    } catch (error) {
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3 py-3 bg-gray-900/70 border ${
                    errors.name ? 'border-red-500' : 'border-gray-700'
                  } rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-10 py-3 bg-gray-900/70 border ${
